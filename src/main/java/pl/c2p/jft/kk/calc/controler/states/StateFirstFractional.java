...
import pl.c2p.jft.kk.calc.controler.States;

public class StateFirstFractional extends State {
    public StateFirstFractional(CalcController controller) {
        super(controller);
    ...
    protected State stateAfterDeleteClicked() {
        return calcController.getState(States.FirstFractional);
        //TODO: moze byc zmiana stanu
    }
