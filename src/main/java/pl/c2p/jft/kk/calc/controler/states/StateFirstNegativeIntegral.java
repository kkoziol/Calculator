...
public class StateFirstNegativeIntegral extends State {
    public StateFirstNegativeIntegral(CalcController controller) {
        super(controller);
    ...
    protected State stateAfterDecimalClicked() {
        return calcController.getState(States.FirstNegativeFractional);
    }
