...
public class StateSecondIntegral extends State {
    public StateSecondIntegral(CalcController controller) {
        super(controller);
    ...
    protected State stateAfterDecimalClicked() {
        return calcController.getState(States.SecondFractional);
    }
