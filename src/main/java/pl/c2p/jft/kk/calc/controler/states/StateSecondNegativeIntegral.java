...
public class StateSecondNegativeIntegral extends State {
    public StateSecondNegativeIntegral(CalcController controller) {
        super(controller);
    ...
    protected State stateAfterDecimalClicked() {
        return calcController.getState(States.SecondNegativeFractional);
    }
